...
{									
  ...
  public:
	...
	String getNameSms(uint8_t index); //return the number of the sms..
	String getTextSms(uint8_t index); //return the number of the sms..  
	void simSleep(); //automatically set modem in sleep mode   
	void simWakeUp(); //automatically set modem in sleep mode  
